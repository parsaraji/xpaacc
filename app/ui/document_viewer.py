...
class DocumentViewer(QWidget):
    def __init__(self, main_window=None):
        ...
        process_btn.setStyleSheet("background-color: #319795; color: white; font-weight: bold; padding: 6px 12px;")
        ...
        self.canvas_lbl.setStyleSheet("background-color: #2d3748;")
        scroll.setWidget(self.canvas_lbl)
        splitter.addWidget(scroll)

        text_panel = QFrame()
        text_panel.setStyleSheet("background-color: #1a202c; border: 1px solid #2d3748;")
        ...
        text_title.setStyleSheet("color: #319795;")
        ...
        self.raw_text_lbl.setStyleSheet("background-color: #11151a; padding: 10px; border-radius: 4px;")
